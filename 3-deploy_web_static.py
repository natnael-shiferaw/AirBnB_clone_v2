#!/usr/bin/python3
"""
- A Fabric script that creates and distributes an
...
def do_pack():
    """A function that is used to generate a tgz archive"""
    try:
...
def do_deploy(archive_path):
    """A function that is used to distribute an
...
def deploy():
    """A function that is used to create and distribute
